...
export const Users = (props: UsersPropsType) => {
    if (props.usersPage.users.length === 0) {
        props.setUsers([
                ...
                {
                    id: 3,
                    photoUrl: 'https://static.vecteezy.com/ti/vettori-gratis/t2/2002403-uomo-con-barba-avatar-personaggio-isolato-icona-gratuito-vettoriale.jpg',
                    followed: false,
                    fullName: 'Andrew',
                    status: 'I am a boss too',
        ...
        <div>
            {
                props.usersPage.users.map(u => <div key={u.id} style={{display: 'flex'}}>
                    <div>
                        <div>
                            <img alt='photo' src={u.photoUrl} className={s.userPhoto}/>
                        </div>
                        <div>
                            {u.followed
                                ? <button onClick={() => {
